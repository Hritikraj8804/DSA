// polynomial representation of linked list.
#include<stdio.h>
#include<stdlib.h>

// 1.create_polynomial()
//		take nothing--> no arrgument
//		returns head pointer to the head polynomial.
// 2.insert_a_term()
//		takes head,coeff,expo values.
// 3.creates a new_term 
// 4.Insert it
//		and return to the head back
// 5.Display
